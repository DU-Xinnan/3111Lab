namespace SinExWebApp20256461.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<SinExWebApp20256461.Models.SinExWebApp20256461Context>
    {
        ...
        protected override void Seed(SinExWebApp20256461.Models.SinExWebApp20256461Context context)
        {
            ...
            context.PakageTypeSizes.AddOrUpdate(
                ...
                new PakageTypeSize { size = "250x350mm", weightLimit = "Not applicable", PackageTypeID = 1 },
                new PakageTypeSize { size = "small - 350x400mm", weightLimit = "5kg", PackageTypeID = 2 },
                new PakageTypeSize { size = "large - 450x500mm", weightLimit = "5kg", PackageTypeID = 2 },
                new PakageTypeSize { size = "1000x80mm", weightLimit = "Not applicable", PackageTypeID = 3 },
                new PakageTypeSize { size = "small - 300x250x150mm", weightLimit = "10kg", PackageTypeID = 4 },
                new PakageTypeSize { size = "medium - 400x350x250mm", weightLimit = "20kg", PackageTypeID = 4 },
                new PakageTypeSize { size = "large - 500x450x350", weightLimit = "30kg", PackageTypeID = 4 }
                );
            // Add shipment data.
